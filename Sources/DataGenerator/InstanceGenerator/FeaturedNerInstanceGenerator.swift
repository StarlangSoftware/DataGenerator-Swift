...
public class FeaturedNerInstanceGenerator : NerInstanceGenerator{
    ...
    public override func addAttributesForWords(current: Instance, sentence: Sentence, wordIndex: Int) {
        ...
        current.addAttribute(attribute: IsLocationGazetteer(surfaceForm: word.getName()))
        ...
        current.addAttribute(attribute: IsOrganizationGazetteer(surfaceForm: word.getName()))
        current.addAttribute(attribute: IsPersonGazetteer(surfaceForm: word.getName()))
