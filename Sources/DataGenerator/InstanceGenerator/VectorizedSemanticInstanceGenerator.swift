...
public class VectorizedSemanticInstanceGenerator : SemanticInstanceGenerator{
     ...
     * and a word format and sets corresponding attributes with these inputs.
     - Parameters:
        - fsm Morphological analyzer used to create multi-word expressions.
        - wordNet WordNet for checking multii-word and single-word expressions.
     ...
     */
    public init(fsm: FsmMorphologicalAnalyzer, wordNet: WordNet, dictionary: VectorizedDictionary, windowSize: Int){
